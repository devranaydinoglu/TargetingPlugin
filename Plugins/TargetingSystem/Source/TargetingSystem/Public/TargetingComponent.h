...
protected:
	...
	// Radius around player to find targets in
	...
	// Determines how much the angle to camera direction affects target scores
	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float CameraDirectionMultiplier;

	// Determines how much the distance to player affects target scores
	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float DistanceMultiplier;

	// Determines how much the angle to player direction affects target scores
	UPROPERTY(BlueprintReadWrite, EditAnywhere, meta = (ClampMin = "0.0", ClampMax = "1.0"))
